package com.open.api.sessionservice.requests;
...
public class SessionsControllerTest {
    ...
    public static void setUpClass() {
        TestWatchman.watchman.registerClass(SessionsControllerTest.class);
    }

    @AfterClass
    public static void tearDownClass() {
        TestWatchman.watchman.createReport(SessionsControllerTest.class);
    }
